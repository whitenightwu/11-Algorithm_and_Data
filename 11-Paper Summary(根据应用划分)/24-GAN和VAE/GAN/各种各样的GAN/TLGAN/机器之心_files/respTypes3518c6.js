...
}else if(118===g)u=f,d=!0,console.log("?#$:"),Wxopen_card.startConnect(f);else if(119===g||120===g)u=f,
...
var W=getParaList(contentWrp),M=void 0!==f.position_index&&f.position_index>=0&&f.position_index<W.length,H=M?f.position_index:Math.ceil(W.length/2)-1;
...
G=!0;else{
var X=require("a/tpl/cpc_tpl.html.js"),F=f.exp_obj.sale_text;
...
if(V=f.crt_size,f.biz_info&&f.biz_info.head_img&&23===v&&(f.avatar=f.biz_info.head_img,
f.avatarTitle=f.biz_info.nick_name),(v===ANDROID_APP_PRODUCT_TYPE||v===IOS_APP_PRODUCT_TYPE)&&(G=!0,
...
avatar:f.avatar
},G&&($.customUpdataFunc=function(e,a){
...
}),ad_render_object["pos_"+f.pos_type]=new CrtManager.createCrtObject(V,Q,js_cpc_area,$),
...
isApp:!1
},ad_render_object["pos_"+f.pos_type]=new CrtManager.createCrtObject(V,Q,js_sponsor_ad_area,$),
...
if(v)1==g.dest_type?handleH5(a,n,idx,mid,biz,r,_,s,d,c,g):6==g.dest_type?Wxopen_card.openWxopen(c):w===ANDROID_APP_PRODUCT_TYPE||w===IOS_APP_PRODUCT_TYPE?handleApp(a,n,idx,mid,biz,r,_,s,d,c,g,o,y):0==g.dest_type?OpenUrlWithExtraWebview(a):(console.info("[APPMSG AD DEBUG] new protocol debug click:",g),
...
x=m[0].clientWidth,j=m[0].clientHeight,ad_click(n,o,p,u,r,f,g,_,y,c,l,d,w,b,x,j,s,h,v),
...
var i=m[0].dataset,t=!!a&&a.target,n=i.type,o=s.button_action.jump_url,p=i.rl,_=i.apurl,r=i.tid,f=i.ticket,g=i.group_id,y=i.aid,v=i.pt,h=s.use_new_protocol;
...
j=u[0].clientWidth,k=u[0].clientHeight,ad_click(n,o,p,_,r,f,g,y,v,c,l,d,b,x,j,k,s,w,h),
