...
r=e&&t?e+"_"+t:"";
var d=i.__webviewid,a=[n,r,d].join("_");
return a;
},o=function(i){
if(20>r)try{
var t=i.vid||"",n={};
...
n.webviewid=a(),n.step=i.step||0,n.orderid=i.orderid||0,n.ad_source=i.ad_source||0,
n.traceid=i.traceid||0,n.ext1=i.ext1||"",n.ext2=i.ext2||"",n.r=Math.random(),n.devicetype=parent.window.devicetype,
n.version=parent.window.clientversion,n.is_gray=d()?1:0,n.mid=o||"",n.idx=w||"",
n.url=parent.window.location.href,n.screen_num=i.screen_num||0,n.screen_height=i.screen_height||0,
n.ori_status=i.ori_status||0,n.fromid=i.fromid||0,n.sessionid=window.sessionid||"";
...
2===showType&&el_bcommentConfirm.setAttribute("disabled","disabled");
var like_report=function(){
log("[Appmsg] click like");
var e=el_like.getAttribute("like"),i=el_likeNum.innerHTML,t=parseInt(e)?parseInt(e):0,n=t?0:1,o=parseInt(i)?parseInt(i):0,l=opt.appmsgid||opt.mid,s=opt.itemidx||opt.idx;
if(t){
if(1!==appmsg_like_type)return void sendRecommendAjax(0);
Class.removeClass(el_like,opt.className),el_like.setAttribute("like",0),o>0&&"100000+"!==i&&(el_likeNum.innerHTML=o-1==0?"赞":o-1);
}else if(1===appmsg_like_type)el_like.setAttribute("like",1),Class.addClass(el_like,opt.className),
"100000+"!==i&&(el_likeNum.innerHTML=o+1);else if(2===appmsg_like_type)return void initRecommendPanel();
RetryAjax({
...
if(1===showType||2===showType)sendRecommendAjax(1,"",showType);else if(3===showType)if(isShow(el_bcommentPanel)||isShow(el_bcommentPanel2))!isShow(el_bcommentPanel)&&isShow(el_bcommentPanel2)?hide(el_bcommentPanel2):isShow(el_bcommentPanel)&&!isShow(el_bcommentPanel2)&&hide(el_bcommentPanel);else{
var e=qs("like3").offsetTop-document.body.scrollTop;
show(el_bcommentPanel),qs("js_b_wrp").clientHeight+e>document.body.clientHeight?Class.addClass(qs("js_b_wrp"),"like_comment_primary_pos_top"):Class.removeClass(qs("js_b_wrp"),"like_comment_primary_pos_top");
}
},isShow=function(e){
...
sendRecommendAjax(1,"",4);
}),DomEvent.on(qs("js_mask_1"),"click",function(){
hide(el_bcommentPanel);
}),DomEvent.on(qs("js_mask_2"),"click",function(){
...
hide(el_bcommentPanel),show(el_bcommentPanel2),el_blikeCommentTextSecond.focus();
}),DomEvent.on(el_bcommentConfirm,"click",function(){
var e;
2===showType?e=3:3===showType&&(e=5),validataComment(el_blikeCommentTextSecond,e);
}),DomEvent.on(el_bcommentCancel,"click",function(){
hide(el_bcommentPanel2),clear(el_blikeCommentTextSecond),vHide(el_bcommentErrorMsg);
}),DomEvent.on(el_acknowledge,"click",function(){
hide(el_likeEducate),2===showType&&show(el_alikeComment);
}),DomEvent.on(el_alikeCommentShare,"click",function(){
show(el_bcommentPanel2),el_blikeCommentTextSecond.focus(),el_bcommentConfirm.setAttribute("disabled","disabled");
});
var unsetLike2Status=function(){
el_toastMsg.innerHTML="已取消",show(el_likeToast),setTimeout(function(){
hide(el_likeToast);
},1e3),2===showType&&isShow(el_alikeComment)&&(hide(el_alikeComment),vHide(el_acommentErrorMsg));
var e=el_likeNum.innerHTML,i=parseInt(e)?parseInt(e):0;
Class.removeClass(el_likeBtn,opt.className),el_like.setAttribute("like",0),el_alikeComment&&hide(el_alikeComment),
i>0&&"100000+"!==e&&(el_likeNum.innerHTML=i-1==0?"":i-1);
},setLike2Status=function(e){
switch(showType){
case 1:
switch(prompted){
case 0:
show(el_likeEducate),prompted=1;
break;
...
case 1:
el_toastMsg.innerHTML=3===e?"已发送":"好看",3===e&&(show(el_likeToast),setTimeout(function(){
hide(el_likeToast);
},1e3)),3===e?hide(el_alikeComment):show(el_alikeComment),scrollToShow(el_alikeComment);
}
3!==e&&setBtnLike();
break;
...
el_like.setAttribute("like",1),Class.addClass(el_likeBtn,opt.className);
var e=el_likeNum.innerHTML,i=parseInt(e)?parseInt(e):0;
"100000+"!==e&&(el_likeNum.innerHTML=i+1);
},scrollToShow=function(e){
window.scrollTo(window.scrollX,e.offsetHeight+window.scrollY);
};
...
e.length>0&&e.length<=200?el_bcommentConfirm.removeAttribute("disabled"):el_bcommentConfirm.setAttribute("disabled","disabled");
});
var validataComment=function(e,i){
var t=e.value.replace(/^\s+|\s+$/g,"");
sendRecommendAjax(1,t,i);
},sendRecommendAjax=function(like,comment,type){
if(!haokanLock){
var appmsgid=opt.appmsgid||opt.mid,itemidx=opt.itemidx||opt.idx,submit_type;
like&&(submit_type=type),haokanLock=!0,ajax({
...
haokanLock=!1;
var data=eval("("+res+")");
0==data.base_resp.ret&&(like?setLike2Status(type):unsetLike2Status(),connectWithApp(like,comment));
},
error:function(){
Tips.showErrTips("系统繁忙，请稍后再试"),haokanLock=!1;
}
});
}
};
...
var i=e||{};
if(i.show){
var t=i.likeAreaDom,n=i.likeNumDom,o=document.getElementById("js_like_btn");
t&&(t.style.display=i.likeAreaDisplayValue,i.liked&&(1===appmsg_like_type?Class.addClass(t,i.className):Class.addClass(o,i.className)),
t.setAttribute("like",i.liked?"1":"0"));
var l=1===appmsg_like_type?"赞":"",s=i.likeNum||l;
parseInt(s)>1e5?s="100000+":"",n&&(n.innerHTML=s);
}
}
function showReadNum(e){
var i=e||{};
if(i.show){
var t=i.readAreaDom,n=i.readNumDom;
t&&(t.style.display=i.readAreaDisplayValue);
var o=i.readNum||1;
parseInt(o)>1e5?o="100000+":"",n&&(n.innerHTML=o);
}
}
var DomEvent=require("biz_common/dom/event.js"),Class=require("biz_common/dom/class.js"),ajax=require("biz_wap/utils/ajax.js"),log=require("appmsg/log.js"),Tips=require("complain/tips.js"),RetryAjax=require("appmsg/retry_ajax.js"),JSAPI=require("biz_wap/jsapi/core.js"),actionString="update_recommend_status",mmversion=require("biz_wap/utils/mmversion.js");
return window.appmsg_like_type=parseInt(window.clientversion,16)>=parseInt("16070530",16)&&0==window.clientversion.indexOf("1")?2:1,
{
