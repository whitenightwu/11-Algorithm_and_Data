...
var _=r[i],m=_.getAttribute("data-src")||"",l=_.getAttribute("src")||m;
if(l){
var c=e("pages/version4video.js");
if(0==l.indexOf("http://z.weishi.com/weixin/player.html"))l=l.replace(/width=\d+/g,"width="+o),
l=l.replace(/height=\d+/g,"height="+s),_.width=o,_.height=s,_.style.setProperty&&(_.style.setProperty("width",o+"px","important"),
_.style.setProperty("height",s+"px","important")),_.setAttribute("src",l),window.__addIdKeyReport&&window.__addIdKeyReport("28307",10),
window.logs.video_cnt++;else if(/http(s)*\:\/\/v\.qq\.com\/iframe\/(preview|player)\.html\?/.test(l)){
if(!c.isShowMpVideo()){
var p;
p=a(b?_:_),p&&A.push(p),"function"==typeof window.__addIdKeyReport&&(window.__addIdKeyReport("28307",10),
...
{
var n=document.getElementById("js_read_area3"),a=document.getElementById("like3"),d=document.getElementById("like_old"),o=document.getElementById("likeNum3"),s=document.getElementById("likeNum_old"),_=document.getElementById("readNum3");
document.getElementById("js_like_title");
}
if(!(n&&a&&o&&_))return;
var l,w,u=e("appmsg/like.js");
1==appmsg_like_type?(l=d,w=s):(l=a,w=o),r.liked=window.is_temp_url?window.liked:r.liked,
u.showReadNum({
show:!0,
readAreaDom:n,
readNumDom:_,
...
showType:window.appmsg_like_type
}));
}
...
n(),window.appmsg_like_type=parseInt(window.clientversion,16)>=parseInt("16070530",16)&&0==window.clientversion.indexOf("1")?2:1,
_();
