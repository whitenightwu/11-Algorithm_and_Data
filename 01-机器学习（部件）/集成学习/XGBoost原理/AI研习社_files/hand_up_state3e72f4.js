...
"use strict";
function e(t,e){
var a="https:"==location.protocol?1500:1200,c=window.__report,u="/mp/advertisement_report?r="+Math.random()+"&ascene="+encodeURIComponent(window.ascene||-1)+"&",l=[],m=!1,y=!1;
for(var f in t)t.hasOwnProperty(f)&&l.push(f+"="+t[f]);
var w=2;
1==window.__ad_has_exposure&&(w=1),l.push("has_exposure="+w),u+=l.join("&");
var g="trace_id="+t.tid+"&product_type="+t.pt+"&jump_url="+t.url+"&logtype=3&url="+encodeURIComponent(location.href)+"&rl="+t.rl;
t.tid&&s.gtVersion("6.3.22",!0)&&p.invoke("adDataReport",{
ad_info:g,
need_record_page_operation:1
},function(){}),d("[Ad report] url="+u),2==w&&window.__addIdKeyReport("68064",0),
window.__ad_test_exposure||window.__addIdKeyReport("68064",7),_.createSign(t,function(o,p,s,_,l){
d("[Ad click real report] url="+u),c&&c(123),i({
url:u,
mayAbort:!0,
type:"GET",
success:function(t){
c&&c(56+n),d("[Ad report suc]"+t),y=!0;
},
error:function(t){
c&&c(57+n),d("[Ad report error]"+t.status+":"+t.responseText);
},
complete:function(){
m||(m=!0,!!e&&e()),d("[Ad report complete]");
},
async:!0
}),setTimeout(function(){
m||(m=!0,window.__ajaxtest="1",c&&c(112),!!e&&e(),d("[Ad report timeout complete]"));
},a),setTimeout(function(){
y||i({
url:u,
type:"GET",
success:function(t){
c&&c(113+n),d("[Ad report suc retry]"+t);
},
error:function(t,e){
c&&c(114+n),d("[Ad report error retry]"+t.status+":"+t.responseText),1==e.type?c&&c(115+n):2==e.type?c&&c(116+n):3==e.type&&c&&c(117+n),
d("[Ad report error detail]"+e.toString());
}
});
},2e3),r(o,p,s,_,l,t,u);
}),o(t);
}
function r(t,e,r,o,a,n,p){
var s=p;
if(s.length>=4e3){
...
aid:+n.aid,
log_type:1,
ext_info:"[url length:"+s.length+"]"+p.substring(0,2e3)
}]
});
i({
...
var i=t("biz_wap/utils/ajax.js"),a=location.protocol,n="https:"==a?5:0,p=t("biz_wap/jsapi/core.js"),s=t("biz_wap/utils/mmversion.js"),d=t("appmsg/log.js"),_=t("a/a_sign.js");
return{
AdClickReport:e
};
